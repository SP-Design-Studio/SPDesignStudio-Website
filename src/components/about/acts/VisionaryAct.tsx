...
export function VisionaryAct({
	...
	return (
		<div
			...
			<div className="min-h-full flex items-center justify-center px-6 sm:px-8 md:px-10 pt-20 sm:pt-24 pb-8 md:py-14">
			<div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 max-w-295 w-full items-center">
				<div className="md:col-span-7 flex flex-col">
					<div
						ref={eyebrowRef}
						className="font-bdscript text-gold tracking-[0.01em] mb-4 md:mb-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
						{ABOUT.visionary.eyebrow}
					</div>
					<div
						ref={titleRef}
						className="font-serif font-light text-plum-dark leading-[1.05] tracking-[-0.01em] mb-3 md:mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
						{ABOUT.visionary.title}
					</div>
					<div
						ref={subtitleRef}
						className="font-serif italic font-light text-plum/55 mb-4 md:mb-7 text-base sm:text-lg md:text-2xl">
						{ABOUT.visionary.subtitle}
					</div>
					<p
						ref={body1Ref}
						className="font-sans font-light text-plum-dark/80 mb-3 md:mb-4 text-sm md:text-base leading-[1.65] md:leading-[1.75] max-w-140">
						{ABOUT.visionary.body1}
					</p>
					<p
						ref={body2Ref}
						className="font-sans font-light text-plum-dark/80 mb-5 md:mb-9 text-sm md:text-base leading-[1.65] md:leading-[1.75] max-w-140">
				...
				<div className="md:col-span-5 md:col-start-8 flex flex-col items-center md:items-end">
					<div className="w-12 md:w-16 h-px bg-gold/60 mb-4 md:mb-5 self-center md:self-end" />
					<div
						ref={imageRef}
						className="relative w-full max-w-50 sm:max-w-75 md:max-w-115">
						...
						<div className="mt-4 font-sans uppercase tracking-[0.32em] text-plum/55 text-[0.7rem] text-right">
							Principal Designer
						</div>
					</div>
				</div>
