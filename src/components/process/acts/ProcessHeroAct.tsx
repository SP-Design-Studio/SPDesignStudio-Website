...
export function ProcessHeroAct({
	...
	return (
		<div
			...
			<p
				ref={subRef}
				className="font-serif italic font-light text-gold text-2xl sm:text-3xl md:text-4xl max-w-2xl">
				{PROCESS.subtitle}
			</p>

			<div ref={introRef} className="mt-8 md:mt-9 flex flex-col items-center">
				<span className="block h-px w-12 bg-gold/50 mb-6 md:mb-7" />
				<p className="font-sans font-normal text-cream/90 text-base md:text-lg leading-[1.85] max-w-xl">
					{PROCESS.intro}
				</p>
				<div className="mt-7 flex items-center gap-3.5 font-sans font-normal uppercase tracking-[0.32em] text-cream/85 text-[0.672rem] md:text-[0.784rem]">
